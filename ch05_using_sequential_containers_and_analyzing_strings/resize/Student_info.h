...
std::vector<Student_info> extract_fails3(std::vector<Student_info> &);
std::list<Student_info> extract_fails4(std::list<Student_info> &);
void remove_fails(std::vector<Student_info> &);
